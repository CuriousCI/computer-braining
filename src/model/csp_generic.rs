// use ai::problem::{Actions, Heuristic, LocalSearch, Problem};
//
...
// }
//
// impl Actions for Constraints {
//     type Action = (usize, i64);
//
//     fn result(&self, state: &Self::State, &(var, val): &Self::Action) -> Self::State {
...
// }
//
// impl Heuristic for Constraints {
//     type Value = usize;
//
...
// }
//
// impl LocalSearch for Constraints {
