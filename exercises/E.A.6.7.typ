...
- $L = |I| + 1$ la lunghezza del percorso che parte da casa, visita tutti i clienti una volta e torna a casa
- $cal(L) = {1, ..., L}$
- $cal(I) = {1, ..., |I|}$ l'insieme che identifica gli elementi in $I$ t.c. $id(1) = "casa"$
- $X = { X_(i, j)^l | (i, j) in "bus" and 1 <= l <= L}$ l'insieme di variabili dove
  - $X_(i, j)^l$ è vera se l'arco $(i, j) in "bus"$ è stato percorso all'$l$-esimo passo
...
$
  ...
  phi.alt_"client_VIP_nella_prima_metà" & = and.big_() \
  phi.alt_"partenza_da_casa" & = and.big_() \
  phi.alt_"arrivo_a_casa" & = and.big_()
$
